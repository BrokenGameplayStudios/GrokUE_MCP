...
> **New session?** Integration Phases 0–5 are **complete**. Read `Docs/NOTES.md` → **Handoff** first, load `/grok-ue-mcp`, then run `GrokProjectTools.health_check` before doing anything else.
